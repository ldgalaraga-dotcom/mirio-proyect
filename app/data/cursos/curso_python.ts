 ...
 * en programación.
 *
 * Este archivo define el modelo de datos (interfaces) y el contenido
 * completo del curso, listo para ser consumido por una app, un sitio
 * web educativo, un LMS o para exportarse a un documento.
 * ============================================================================
 */
...
export interface RecursoApoyo {
  ...
  titulo: string;
  descripcion: string;
  enlaceSugerido?: string; // El docente puede reemplazarlo por el recurso institucional real
}
...
export interface Evaluacion {
  ...
  descripcion: string;
  criterios: string[];
  porcentaje: number; // % dentro del nivel
}
...
export const cursoPythonPrincipiantes: Curso = {
...
export default cursoPythonPrincipiantes;
